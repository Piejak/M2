 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Johnny Lee");
		  toPrint += p1.toString("jlee3057");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Brian Piejak");
		  toPrint += p2.toString("bpiejak3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id

		  Person3 p3 = new Person3("Yudong Shao");
		  toPrint += p3.toString("yshao72");
      //Person4 replace P4 with your name
      //and gburdell4 with your gt id
      Person4 p4 = new Person4("Hui Li");
      toPrint += p4.toString("hli615");
      //Person5 replace P4 with your name
      //and gburdell5 with your gt id
      Person5 p5 = new Person5("Jimmy Dinh-Nguyen");
      toPrint += p5.toString("jpdn3");
     ...
     * @param args arguments with no use for main method
     */
